      ...
      <div className="relative z-10 container mx-auto px-4 py-8 md:py-16">
        <div className="max-w-4xl mx-auto text-center mb-12 animate-fadeIn">
          <div className="flex items-center justify-center mb-4">
            ...
            <h2 className="text-4xl md:text-5xl font-bold px-4">Zašto CSCZ?</h2>
            <div className="w-20 h-1 bg-blue-500 rounded"></div>
          </div>
          <p className="text-xl text-blue-200 mt-2">Zašto izabrati Savremeni Srpski Centar za Znanje?</p>
        </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-10 max-w-6xl mx-auto">
          ...
          <div className="space-y-6 animate-slideIn">
            <div className="bg-white/10 backdrop-blur-md p-6 rounded-lg border border-white/20 hover:bg-white/15 transition-all">
              ...
              <p className="text-gray-100 text-lg">
                Savremeni Srpski Centar za Znanje (CSCZ) je vodeća institucija za online obrazovanje u Srbiji, nudeći inovativne programe i savremene metode nastave. Naša platforma omogućava vrhunsko obrazovanje bez geografskih ograničenja, dostupno u svakom trenutku.
              </p>
            </div>
            ...
            <div className="bg-white/10 backdrop-blur-md p-6 rounded-lg border border-white/20 hover:bg-white/15 transition-all">
              ...
              <p className="text-gray-100 text-lg">
                Naša studentska zajednica je najveća snaga CSCZ-a. Studenti razvijaju komunikacione i timske veštine kroz zajedničke projekte. Naš centar je kao velika porodica u kojoj se svaki glas čuje.
              </p>
            </div>
          </div>
          ...
          <div className="space-y-6 pt-0 md:pt-16 animate-slideUp">
            <div className="bg-white/10 backdrop-blur-md p-6 rounded-lg border border-white/20 hover:bg-white/15 transition-all">
              ...
              <p className="text-gray-100 text-lg">
                CSCZ nudi raznovrsne interesne grupe uključujući programiranje, dizajn igara, robotiku i strane jezike. Naši napredni alati i interaktivne metode čine online učenje zanimljivim i efikasnim, pripremajući studente za izazove savremenog sveta.
              </p>
            </div>
            ...
            <div className="bg-white/10 backdrop-blur-md p-6 rounded-lg border border-white/20 hover:bg-white/15 transition-all">
              ...
              <p className="text-gray-100 text-lg">
                CSCZ je idealan izbor za one koji cene slobodu učenja i žele da se razvijaju u inspirativnom okruženju. Prilagođavamo plan učenja svakom studentu prema individualnim potrebama i tempu.
              </p>
            </div>
          </div>
        </div>
